...
`init_db.sql` is the file for creating the database found [at this link](#https://github.com/lgarceau768/group16itcs3160project/blob/master/sql_commands/init_db.sql)
